...
- Approach: The model approach is the Bayesian Optimization, using the Gaussian process model and acquisition function that goes between UCB (Upper Confident
Bound) or EI (Expected Improvement) depending on the requirements.The current version is round 10
